...
var pagingKeys = function() {
	...
	// settings
	var config = {
    nodeSelector:        '#main .view-frontpage .node h2.node-title a',  // used to select each item on the page and place in the map (must be a link)
    prevPageSelector:    '.pager-previous a',                // link on this element should always jump to prev page a.prev_page (must be a link)
		nextPageSelector:    '.pager-next a',                // link on this element should always jump to next page a.next_page (must be a link)
