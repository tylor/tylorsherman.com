<?php
// $Id: node.tpl.php,v 1.1.4.8 2009/03/19 23:49:01 couzinhub Exp $
...
<div class="node <?php echo $node_classes; ?>" id="node-<?php echo $node->nid; ?>">
    ...
    <?php if ($submitted): ?>
      <?php /* <span class="submitted"><?php echo $submitted; ?></span> */ ?>
      <span class="submitted"><?php print format_date($node->created, 'custom', 'M d, Y'); ?></span>
    <?php endif; ?>
