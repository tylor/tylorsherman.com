...
<body class="<?php echo $body_classes; ?>">
  ...
  <div id="page">
	...
	<div id="header">
    	...
    	<div id="get-social">
    		<ul>
    			<li><a href="http://twitter.com/tylorsherman" id="twitter"></a></li>
    			<li><a href="http://flickr.com/photos/runforcover" id="flickr"></a></li>
    			<li><a href="http://drupal.org/user/143420" id="drupal"></a></li>
    			<li><a href="http://facebook.com/tylor" id="facebook"></a></li>
    			<li><a href="http://del.icio.us/SAVshermanONA" id="delicious"></a></li>
    			<li><a href="http://www.last.fm/user/SAVshermanONA" id="lastfm"></a></li>
    			<li><a href="http://qik.com/tylor" id="qik"></a></li>
    			<li><a href="http://www.vimeo.com/tylor" id="vimeo"></a></li>
